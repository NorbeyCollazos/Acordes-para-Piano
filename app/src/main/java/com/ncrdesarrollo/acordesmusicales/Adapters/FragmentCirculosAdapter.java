...
public class FragmentCirculosAdapter extends FragmentStateAdapter {

    ArrayList<AcordesCirculo> list;

    public FragmentCirculosAdapter(@NonNull Fragment fragment, ArrayList<AcordesCirculo> list) {
        super(fragment);
        this.list = list;
    }
    ...
    public Fragment createFragment(int position) {
        Fragment fragment = new ContenedorCirculosFragment();
